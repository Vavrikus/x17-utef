...
\begin{document}
	...
	\begin{frame}
		...
		\begin{columns}
			\column{0.33\textwidth}
			\centering
			\includegraphics[width = 0.95 \linewidth]{../../figures/drift_7030_yz_small.pdf}
			Diffusion front view
			\column{0.33\textwidth}
			\centering
			\includegraphics[width = 0.95 \linewidth]{../../figures/drift_7030_xz_small.pdf}
			Electron drift
			\column{0.33\textwidth}
			\centering
			\includegraphics[width = 0.95 \linewidth]{../../figures/drift_7030_xy_small.pdf}
			Diffusion top view
		\end{columns}
	\end{frame}
	...
	\begin{frame}
		...
		\begin{columns}
			...
			\begin{minipage}[t][4.2cm]{\textwidth}
				\centering
				\includegraphics[width = \textwidth]{../../figures/pad_12_grad.pdf}\\
				\vspace{-0.5cm}
			...
			\begin{minipage}[t][4.2cm]{\textwidth}
				\centering
				\includegraphics[width = \textwidth]{../../figures/pad_66_interpol.pdf}\\
				\vspace{-0.5cm}
				{Pad 66}
			\end{minipage}
			\column{0.06\textwidth}
