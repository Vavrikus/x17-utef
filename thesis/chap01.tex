...
\label{sec:tpc}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.7\textwidth]{particle_id.png}
	...
	\section{Readout}
		...
		\subsection{Gas Electron Multiplier}
			...
			\begin{figure}
				\centering
				\includegraphics[width=0.8\textwidth]{gem_hole.png}
				\caption{A~scanning electron microscope image of a~\ac{GEM} foil.}
				\label{fig:gemhole}
			\end{figure}
			\begin{figure}
				\centering
