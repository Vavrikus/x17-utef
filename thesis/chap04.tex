...
\label{sec:energy}
	...
	\label{sec:rkfit}
		...
		\begin{figure}
			...
			\end{subfigure}
			\caption{Demonstration of the convexity of the distance function $d(\alpha)$ for a~circular track (see Equation~\ref{eq:rkdemo}). Made with GeoGebra®.}
			\label{fig:rkdemo}
		\end{figure}
