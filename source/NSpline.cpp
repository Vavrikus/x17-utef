...
namespace X17
{
  void RecoEnergy(TSpline3* sp_fit, const Field<Vector>& magfield, TGraph* energy, // NOLINT(misc-use-internal-linkage)
                  TGraph* radius, TGraph* magnetic, double min, double max, double step)
  {
