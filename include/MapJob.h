...
namespace X17
{
  ...
  const double tan30 = std::numbers::sqrt3 / 3;
  ...
  public:
    ...
    [[nodiscard]] double SectorLineDist(double x, double y, bool min) const;
    ...
    /// @brief Calculates number of electrons and total distance to propagate for current job. Sets minimal and maximal
    /// electron index.
